...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VIVADO/seno_function/seno_function.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log exemplo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source exemplo.tcl
