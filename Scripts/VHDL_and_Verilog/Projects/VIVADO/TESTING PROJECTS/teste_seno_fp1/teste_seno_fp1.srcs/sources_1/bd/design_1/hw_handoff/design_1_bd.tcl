...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net sim_clk_gen_0_clk [get_bd_pins cordic_0/aclk] [get_bd_pins sim_clk_gen_0/clk]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins cordic_0/s_axis_phase_tvalid] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins cordic_0/s_axis_phase_tdata] [get_bd_pins xlconstant_1/dout]
