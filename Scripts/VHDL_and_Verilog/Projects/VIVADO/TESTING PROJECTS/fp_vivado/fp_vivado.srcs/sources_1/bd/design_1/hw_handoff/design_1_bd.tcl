...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.INITIAL_RESET_CLOCK_CYCLES {2} \
  ...
  connect_bd_net -net LOGIC_SOURCE_0_HIGH [get_bd_pins floating_point_0/s_axis_a_tvalid] [get_bd_pins floating_point_0/s_axis_b_tvalid] [get_bd_pins sim_clk_gen_1/clk]
  connect_bd_net -net sim_clk_gen_0_clk [get_bd_pins floating_point_0/aclk] [get_bd_pins sim_clk_gen_0/clk]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins floating_point_0/s_axis_a_tdata] [get_bd_pins floating_point_0/s_axis_b_tdata] [get_bd_pins xlconstant_0/dout]
