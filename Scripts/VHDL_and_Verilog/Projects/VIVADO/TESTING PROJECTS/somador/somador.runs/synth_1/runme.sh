...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VIVADO/somador/somador.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log somador.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source somador.tcl
