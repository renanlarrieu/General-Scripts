...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VHDL/VHDL PROJECTS/VIVADO/TESTING PROJECTS/SINE_WAVE_REALLLLLLLLLL/SINE_WAVE_REALLLLLLLLLL.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SinGenerator.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SinGenerator.tcl
