...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VHDL/VHDL PROJECTS/VIVADO/TESTING PROJECTS/SINE_WAVE_REALLLLLLLLLL/SINE_WAVE_REALLLLLLLLLL.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SinGenerator.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SinGenerator.tcl -notrace
