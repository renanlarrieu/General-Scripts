...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VHDL_VERILOG/VHDL_VERILOG PROJECTS/VIVADO/TESTING PROJECTS/teste_clock3/teste_clock3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log teste_clock3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source teste_clock3.tcl
