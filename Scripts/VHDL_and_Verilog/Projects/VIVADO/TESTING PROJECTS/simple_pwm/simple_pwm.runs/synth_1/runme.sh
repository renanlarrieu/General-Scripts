...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VIVADO/simple_pwm/simple_pwm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log func_gen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source func_gen.tcl
