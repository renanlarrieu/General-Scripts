...
--signal tensao : std_logic_vector(width_g-1 downto 0);
--signal multiplicador: std_logic_vector(width_g-1 downto 0) := (others=>'0'); -- sine signal
