...
copy_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VHDL_and_Verilog/Projects/VIVADO/SUCESSFUL PROJECTS/SINE_WAVE_REUNIAO/SINE_WAVE_REUNIAO.cache/compile_simlib/modelsim"
  fi
