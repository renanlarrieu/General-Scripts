...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VHDL/VHDL PROJECTS/VIVADO/SUCESSFUL PROJECTS/PWM_MULTI_PORTAS/PWM_MULTI_PORTAS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_multi_portas.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PWM_multi_portas.tcl
