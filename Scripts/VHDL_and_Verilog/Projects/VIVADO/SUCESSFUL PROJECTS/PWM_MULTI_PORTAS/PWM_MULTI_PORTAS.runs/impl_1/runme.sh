...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VHDL/VHDL PROJECTS/VIVADO/SUCESSFUL PROJECTS/PWM_MULTI_PORTAS/PWM_MULTI_PORTAS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PWM_multi_portas.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PWM_multi_portas.tcl -notrace
