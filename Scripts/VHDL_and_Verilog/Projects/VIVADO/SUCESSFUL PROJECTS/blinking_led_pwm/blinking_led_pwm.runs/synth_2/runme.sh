...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VHDL/VHDL PROJECTS/VIVADO/blinking_led_pwm/blinking_led_pwm.runs/synth_2'
cd "$HD_PWD"
...
EAStep vivado -log blinking_led_pwm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blinking_led_pwm.tcl
