...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VHDL/VHDL PROJECTS/VIVADO/blinking_led_pwm/blinking_led_pwm.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testebench_blink_pwm.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testebench_blink_pwm.tcl
