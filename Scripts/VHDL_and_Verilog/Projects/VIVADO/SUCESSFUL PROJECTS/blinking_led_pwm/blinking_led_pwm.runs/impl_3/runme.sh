...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VHDL_and_Verilog/Projects/VIVADO/SUCESSFUL PROJECTS/blinking_led_pwm/blinking_led_pwm.runs/impl_3'
cd "$HD_PWD"
...
EAStep vivado -log blinking_led_pwm.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source blinking_led_pwm.tcl -notrace
