...
#Author: Propulsão + Renan larrieu FEN-PEL
...
m1=float(input("Fluxo de oxidante [g/s] : "))
...
#m1=250#massa do oxidante em gramas g/s#
...
plt.title("Fluxo de massa total x tempo",fontsize=40)

plt.xlabel('Tempo [s]',fontsize=40) #nome do eixo x
plt.ylabel('Fluxo de massa total [kg/s]',fontsize=40) #nome do eixo y
plt.plot(lista_tempo, lista_fluxo_total, color='blue',linewidth=4.0, linestyle = '-') #dois graficos em 1
...
plt.title("Fluxo de massa de combustível x tempo",fontsize=40)

plt.xlabel('Tempo [s]',fontsize=40) #nome do eixo x
plt.ylabel('Fluxo de massa combustível [g/s]',fontsize=40) #nome do eixo y
plt.plot(lista_tempo, lista_massa_combustivel, color='red',linewidth=4.0, linestyle = '-') #dois graficos em 1
...
plt.title("Razão OF x tempo",fontsize=40)

plt.xlabel('Tempo [s]',fontsize=40) #nome do eixo x
plt.ylabel('Razão OF',fontsize=40) #nome do eixo y
plt.plot(lista_tempo,lista_fluxo_of, color='orange',linewidth=4.0, linestyle = '-') #dois graficos em 1
plt.scatter(lista_tempo,lista_fluxo_of, color='red', marker = '*')#, s= z) #dois graficos em 1
#plt.fill_between(x,0,y, color = 'grey') #pinta a área sob a curva
plt.grid(True, which='both')
plt.tick_params(labelsize=40);  
#---------------------------------------------------  
fig4 = plt.gcf() #cria a figura    
plt.rcParams['figure.figsize'] = (40,30) #tamanho do gráfico
fig4, ax = plt.subplots() #anexa os subplots na figura
ax.yaxis.set_minor_locator(tck.AutoMinorLocator())
plt.rcParams.update({'font.size': 22})

plt.title("Pressão x tempo",fontsize=40)

plt.xlabel('Tempo [s]',fontsize=40) #nome do eixo x
plt.ylabel('Pressão [psi]',fontsize=40) #nome do eixo y
plt.plot(lista_tempo,lista_pressão, color='black',linewidth=4.0, linestyle = '-') #dois graficos em 1
...
fig5 = plt.gcf() #cria a figura    
plt.rcParams['figure.figsize'] = (40,30) #tamanho do gráfico
fig5, ax = plt.subplots() #anexa os subplots na figura
ax.yaxis.set_minor_locator(tck.AutoMinorLocator())
plt.rcParams.update({'font.size': 22})

plt.title("Força x tempo",fontsize=40)

plt.xlabel('Tempo [s]',fontsize=40) #nome do eixo x
plt.ylabel('Força [N]',fontsize=40) #nome do eixo y
plt.plot(lista_tempo,lista_força, color='blue',linewidth=4.0, linestyle = '-') #dois graficos em 1
plt.scatter(lista_tempo,lista_força, color='red', marker = '*')#, s= z) #dois graficos em 1
#plt.fill_between(x,0,y, color = 'grey') #pinta a área sob a curva
plt.grid(True, which='both')
plt.tick_params(labelsize=40);  
...
plt.title("OXFL x tempo",fontsize=40)

plt.xlabel('Tempo [s]',fontsize=40) #nome do eixo x
plt.ylabel('OXFL [kg/m²]',fontsize=40) #nome do eixo y
plt.plot(lista_tempo,lista_oxfl, color='purple',linewidth=4.0, linestyle = '-') #dois graficos em 1
