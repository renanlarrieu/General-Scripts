...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VIVADO/teste_senoide/teste_senoide.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sinewave.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sinewave.tcl
