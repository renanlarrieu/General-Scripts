...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VIVADO/teste_senoide/teste_senoide.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log sinewave.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source sinewave.tcl -notrace
