...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VIVADO/function/function.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log function_example.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source function_example.tcl
