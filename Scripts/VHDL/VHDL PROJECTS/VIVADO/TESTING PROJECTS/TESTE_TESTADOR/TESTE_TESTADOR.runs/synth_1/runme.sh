...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VHDL/VHDL PROJECTS/VIVADO/TESTE_TESTADOR/TESTE_TESTADOR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log testar_pacote_JHU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source testar_pacote_JHU.tcl
