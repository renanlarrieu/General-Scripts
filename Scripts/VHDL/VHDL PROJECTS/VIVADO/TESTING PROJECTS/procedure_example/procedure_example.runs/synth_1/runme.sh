...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VIVADO/procedure_example/procedure_example.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log procedimento.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source procedimento.tcl
