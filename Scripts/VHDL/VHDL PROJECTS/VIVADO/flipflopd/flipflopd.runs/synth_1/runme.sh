...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VIVADO/flipflopd/flipflopd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flipflopd_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flipflopd_tb.tcl
