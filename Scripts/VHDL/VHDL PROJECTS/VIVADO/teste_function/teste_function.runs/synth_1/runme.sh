...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VIVADO/teste_function/teste_function.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log teste_function.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source teste_function.tcl
