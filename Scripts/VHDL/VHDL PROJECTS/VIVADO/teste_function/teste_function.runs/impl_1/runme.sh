...
HD_PWD='C:/Users/Renan/Documents/GitHub/Shared-Scripts/Scripts/VIVADO/teste_function/teste_function.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log teste_function.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source teste_function.tcl -notrace
